...
class YylCmdLogger {
    constructor(op) {
        this.typeInfo = {
            info: {
                name: 'INFO',
                color: source.bgBlack.gray,
                shortName: 'i',
                shortColor: source.gray
            },
            warn: {
                name: 'WARN',
                shortName: '!',
            ...
            del: {
                name: 'DEL ',
                shortName: '-',
                color: source.bgGray.black,
                shortColor: source.gray
            },
            add: {
                name: 'ADD ',
                shortName: '+',
                color: source.bgBlue.white,
                shortColor: source.blue
            },
            update: {
                name: 'UPDT',
                shortName: '~',
                color: source.bgMagenta.white,
                shortColor: source.magenta
            },
            cmd: {
                name: 'CMD>',
                shortName: '>',
                color: source.bgBlack.white,
                shortColor: source.white
            }
        };
        /** progress icon 信息 */
        this.progressInfo = {
